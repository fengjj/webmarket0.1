 ...
 * Create on 2015-5-18
 * @author: dongyh
 * @Title: CompInitReleaseInDTO
 * @Description： 打印入参参数
 * @version 1.0 
 * update_data:      update_author:      update_note:
 */
public class CompInitReleaseInDTO extends StandardInDTO {
	...
	@ParamDesc(path="BUSI_CLASS",cons=ConsType.CT001,len="100",type="String",desc="活动类型",memo="略")
	private String busiClass;
	@ParamDesc(path="CLASS_VALUE",cons=ConsType.CT001,len="100",type="String",desc="活动小类",memo="略")
