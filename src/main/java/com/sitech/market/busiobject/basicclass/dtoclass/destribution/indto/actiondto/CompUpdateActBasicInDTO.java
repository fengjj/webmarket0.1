...
public class CompUpdateActBasicInDTO extends InDTO{
	...
	@ParamDesc(path="regions",cons=ConsType.CT001,type="JSONArray",len="40",desc="针对区域",memo="" ,cls=JSONArray.class)
	...
	public void decode(MBean arg0) {
		...
		System.out.println(getPathByProperName("regions"));
