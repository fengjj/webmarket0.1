...
public class AtomSaveAttachCustGroupInDTO extends StandardInDTO {
	...
	@ParamDesc(path="IMPORT_BUSI_TYPE",cons=ConsType.QUES,len="5",type="string",desc="导入批量类型",memo="略")
	private String importBusiType;
	@ParamDesc(path="CUST_REL_SERIAL_ID",cons=ConsType.QUES,len="18",type="string",desc="业务客户群关系id",memo="略")
	private String custRelSerialId;
	@ParamDesc(path="CUST_LIST",cons=ConsType.STAR,len="100000",type="compx",desc="导入批量数据集合",memo="略")
