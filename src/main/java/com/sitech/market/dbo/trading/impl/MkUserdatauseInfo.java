...
public class MkUserdatauseInfo extends DBNosqlClass implements IMkUserdatauseInfo {
	/**
	 * Create on 2015-7-22 
	 * @author: zhaoyue
	 * @Title: selectMkUserdataUseInfoByRowKye 
	 * @Description: 查询mk_userdatause_info 数据
	 * @param rowKey
	 * @return 
	 * @version 1.0 
	...
	public JSONObject selectMkUserdataUseInfoByRowKye(String rowKey) {
		...
		try {
			json=cassandraDao.query_by_key("mk_userdatause_info", rowKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return json;
